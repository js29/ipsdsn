...
parser.add_argument("--bamsortThreadN", help = "Number of cores to use.", default = "1")
parser.add_argument("--quantMode", help = "STAR quantMode parameter (e.g. TranscriptomeSAM).")
...
for line in fileinput.input("-"):
	...
	standard_flags =  "--readFilesCommand zcat --outSAMtype BAM Unsorted SortedByCoordinate --outWigType bedGraph --outWigStrand Stranded --outWigNorm RPM --limitBAMsortRAM 26000000000"
	...
	quantModeArg = ""
	if args.quantMode:
		quantModeArg = "--quantMode " + args.quantMode
	command = " ".join(["STAR", "--runThreadN", args.runThreadN, "--outBAMsortingThreadN", args.bamsortThreadN, "--genomeDir", args.genomeDir, "--outFileNamePrefix", out_prefix, "--readFilesIn", read1_file, read2_file, standard_flags, quantModeArg])
	print(command)
